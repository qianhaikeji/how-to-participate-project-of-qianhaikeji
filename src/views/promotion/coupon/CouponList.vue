<template>
  <div class="coupon-list">
    <el-row class="coupon-list-top-bar">
      <el-col :span="4"><el-input v-model="couponQuery.id" placeholder="优惠券ID"></el-input></el-col>
      <el-col :span="4" :offset="1"><el-input v-model="couponQuery.fuzzy" placeholder="标题"></el-input></el-col>
      <el-col :span="2" :offset="10"><el-button type="primary" @click="$router.push('/promotion/coupon/new')">查询</el-button></el-col>
    ...
    <pagination :fetch-data="fetchCoupons" v-on:fetched="couponsFetched"></pagination>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    fetchCoupons: function (pageParams) {
      let queryParams = Object.assign({}, this.couponQuery, pageParams)
